        ...
        return (
          <>
            <h3 className='cust_par fs-3 fs-md-2 fs-lg-1'>
              Buy Homes, Cars, and Bikes with <br className="d-none d-md-block" /> Ease — One Platform
            </h3>
            ...
            <Button className='get_started_btn fs-6 fs-md-5 fs-lg-4'>Get Started</Button>
          </>
        );
      case "listings":
        return (
  ...
  return (
    <div className='hero-section'>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            ...
            <Nav className="align-items-center">
              <Nav.Link
                as={Link}
                to="/"
                className={`custom_txt fs-6 fs-md-5 fs-lg-4 ${location.pathname === "/" ? "active" : ""}`}
              ...
              <Nav.Link
                as={Link}
                to="/listings"
                className={`custom_txt fs-6 fs-md-5 fs-lg-4 ${location.pathname === "/listings" ? "active" : ""}`}
              ...
              <Nav.Link
                as={Link}
                to="/contact"
                className={`custom_txt fs-6 fs-md-5 fs-lg-4 ${location.pathname === "/contact" ? "active" : ""}`}
                onClick={() => setActiveTab("contact")}
              >
                Contact Us
              </Nav.Link>
              <Button className='get-in-touch-btn ms-2 mt-2 mt-lg-0 fs-6 fs-md-5 fs-lg-4'>Get in touch</Button>
            </Nav>
          </Navbar.Collapse>
        </Container>
      </Navbar>
      ...
      <Row className="align-items-center custom_image_section_head">
        <Col md={6} sm={12} className="text-center text-md-start p-5">
          {renderContent()}
        </Col>
